...
# XML, art and sound files, show with find /etc/emulationstation/themes/simple/ -type f -name "*.jpg" -o -name "*.png" -o -name "*.wav" -o -name "*.xml" -o -name "*.txt" -o -name "*.ttf" -o -name "*.svg" -o -name "*.TTF" | sort
